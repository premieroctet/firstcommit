...
export default function Commit({ commit }: { commit: GithubCommit }) {
    return <a href={commit.html_url} target="_blank" rel="noopener noreferrer" className="w-[500px] bg-[white] text-left flex items-center text-[black] no-underline transition-all duration-[0.2s] ease-[ease-in-out] mt-[50px] mx-auto my-0 p-2.5 rounded-[5px] hover:scale-[1.04]">
